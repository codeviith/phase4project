...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        item3 = Item(name="1000cc power pack", price=1555.99, image_url="ihttps://www.revzilla.com/product_images/1587/0687/ss_power_pack4_bore585_chain0717_tc_exc1416_twin_cooled_750x750.jpg", stock=80, category="Engine Parts", brand="Screaming Eagle")
        item4 = Item(name="1250cc Custom pack", price=1789.99, image_url="ihttps://www.revzilla.com/product_images/1586/7933/ss_power_package_for_harley_oil_cooled114_milwaukee_eight20172021_750x750.jpg", stock=50, category="Engine Parts", brand="Hammer Performance")
        item5 = Item(name="Harley cilinder heads", price=1450.99, image_url="https://www.revzilla.com/product_images/0104/6738/ss_super_stock_50inder_heads_for_harley_twin_cam_black_750x750.jpg", stock=70, category="Engine Parts", brand="Screaming Eagle")
        ...
        item15 = Item(name="Brake Front Rotor", price=290.99, image_url="ihttps://www.revzilla.com/product_images/0236/2379/arlen_ness14_big_brake_front_rotors_for_harley_750x750.jpg", stock=60, category="Brakes", brand="Arlen Ness")
        ...
        item17 = Item(name="LV-10 Slip-On Exhaust", price=630.99, image_url="ihttps://www.revzilla.com/product_images/0365/1893/leo_vince_lv10_slip_on_exhaust_z1000_ss_black_stainless_steel_750x750.jpg", stock=60, category="Exhaust Systems", brand="LeoVince")
